...
import Encryption from "react-secure-storage/src/lib/encryption.js";
import {getDecryptedAccessToken, storeAccessToken} from "../../utils/tokenUtils.js";
    ...
    const loginWithGoogle = async () => {
        ...
        try {
            ...
            try {
                ...
                // const ENCRYPT_KEY = import.meta.env.VITE_SECRET_KEY || "teco_access_token";
                // secureLocalStorage.setItem(ENCRYPT_KEY, data?.accessToken);
                storeAccessToken(data?.accessToken)
                console.log("======> AterDecrypted: ",getDecryptedAccessToken())
                navigate("/products");
            }
            if(!data.accessToken){
                navigate("/login");
