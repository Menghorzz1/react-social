...
import {useLoginWithGoogle} from "../../components/social-auth/GoogleAuthComponent.jsx";
import { useLoginWithFacebook } from "../../components/social-auth/FacebookAuthComponent";
import {useLoginWithGitHub} from "../../components/social-auth/GitHubAuthComponent.jsx";

// import social media image
import FacebookLogin from "../../assets/facebook.jpg";
      ...
      <div>
        ...
        <div className="flex gap-2 items-center w-full justify-center mt-2">
          ...
          <button onClick={loginWithFacebook}>
            <img src={FacebookLogin} alt="facebook provider" width={30} height={30} />
          </button>
          {/* for github  */}
